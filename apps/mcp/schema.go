...
// introducing a codegen step or a shared dependency. Intentionally copied
// from apps/server/internal/httphandler/mcp/schema.go per the "share by copy,
// not import" rule — the three modules stay independent.
